...
public class bookAlbertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_albert);
        ...
        if (database.isBookPurchased("bookAlbert")) {
    ...
    private boolean purchaseBook() {
        ...
        if (currentBalance >= BOOK_PRICE) {
            ...
            database.markPurchased("bookAlbert");
            Toast.makeText(this, "Buku berhasil dibeli", Toast.LENGTH_SHORT).show();
        } else {
